...
def test_data():
    ...
    sample_measures = [
        {
            ...
            "installed_cost": {"all residential": 1, "all commercial": 2},
            "cost_units": {"all residential": "cost unit 1", "all commercial": "cost unit 2"},
            "energy_efficiency": {
                "all residential": {"heating": 111, "cooling": 111},
                "all commercial": 222,
            },
            ...
            "product_lifetime": {"all residential": 11, "all commercial": 22},
            "climate_zone": "all",
            "bldg_type": "all",
            "structure_type": "all",
            "fuel_type": "all",
        ...
        },
        {
            ...
            "market_entry_year": None,
            "market_exit_year": None,
            "installed_cost": {"all residential": 1, "assembly": 2, "education": 2},
            "cost_units": {
            ...
            "product_lifetime": {"all residential": 11, "assembly": 22, "education": 22},
            "climate_zone": "all",
            "bldg_type": ["all residential", "assembly", "education"],
            "structure_type": "all",
            "fuel_type": "all",
            "fuel_switch_to": None,
            "end_use": "all",
        ...
        },
        {
            ...
            "fuel_type": "all",
            "fuel_switch_to": None,
            "end_use": ["heating", "cooling", "secondary heating"],
            "technology": "all",
        },
        {
            ...
            "fuel_switch_to": None,
            "end_use": ["lighting", "water heating"],
            "technology": "all",
        },
        {
            ...
            "installed_cost": 999,
            "cost_units": "dummy",
            "energy_efficiency": {"primary": 999, "secondary": None},
            "energy_efficiency_units": {"primary": "dummy", "secondary": None},
            "product_lifetime": 999,
            "climate_zone": "all",
            ...
            "fuel_switch_to": None,
            "end_use": ["heating", "water heating"],
            "technology": ["all heating", "electric WH"],
        },
        {
        ...
        },
        {
            ...
            "product_lifetime": 999,
            "climate_zone": "all",
            "bldg_type": ["all residential", "small office"],
            "structure_type": "all",
            "fuel_type": "natural gas",
            "fuel_switch_to": None,
            "end_use": "heating",
    ...
    sample_measures_in = [
        Measure(base_dir, handyvars, handyfiles, opts_dict, **x) for x in sample_measures
    ]
    ok_primary_cpl_out = [
        [
            {
            ...
            },
            {
                ...
                "food service": "cost unit 2",
                "health care": "cost unit 2",
                "large office": "cost unit 2",
                "lodging": "cost unit 2",
                "mercantile/service": "cost unit 2",
                "mobile home": "cost unit 1",
                "multi family home": "cost unit 1",
                "other": "cost unit 2",
                "single family home": "cost unit 1",
                "small office": "cost unit 2",
                "warehouse": "cost unit 2",
            ...
            },
            {
                ...
                "food service": "energy unit 2",
                "health care": "energy unit 2",
                "large office": "energy unit 2",
                "lodging": "energy unit 2",
                "mercantile/service": "energy unit 2",
                "mobile home": "energy unit 1",
                "multi family home": "energy unit 1",
                "other": "energy unit 2",
                "single family home": "energy unit 1",
                "small office": "energy unit 2",
                "warehouse": "energy unit 2",
    ...
    ok_primary_mkts_out = [
        ...
        [
            ["AIA_CZ1", "AIA_CZ2", "AIA_CZ3", "AIA_CZ4", "AIA_CZ5"],
            ["single family home", "multi family home", "mobile home", "assembly", "education"],
            ["new", "existing"],
            ["electricity", "natural gas", "distillate", "other fuel"],
            [
                "drying",
        ...
        [
            ...
            "natural gas",
            "heating",
            ["res_type_gasHP-heat", "gas_eng-driven_RTHP-heat", "gas_boiler", "gas_furnace"],
        ],
        [
            ["AIA_CZ1", "AIA_CZ2", "AIA_CZ3", "AIA_CZ4", "AIA_CZ5"],
            ["single family home", "multi family home", "mobile home", "small office"],
            ["new", "existing"],
            "natural gas",
            "heating",
            [
...
def test_fill(test_data):
    ...
    for ind, m in enumerate(test_data["sample_measures_in"]):
        ...
        assert [
            sorted(x, key=lambda x: (x is None, x)) if isinstance(x, list) else x
            for x in [
                m.climate_zone,
                m.bldg_type,
                m.structure_type,
            ...
            sorted(x, key=lambda x: (x is None, x)) if isinstance(x, list) else x
            for x in test_data["ok_primary_mkts_out"][ind]
        ]
